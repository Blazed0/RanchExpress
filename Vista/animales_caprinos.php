     ...
     <div class="container mt-4">
      <div class="row g-4 justify-content-center">
        ...
        <div class="row text-center mb-4 gx-2 gy-2">
          <div class="col-md-4 align-items-center"><?php echo $htmlMacho; ?></div>
          <div class="col-md-4 align-items-center justify-content-center"><?php echo $htmlHembra; ?></div>
          <div class="col-md-4"><?php echo $htmlCrias; ?></div>
        </div>
      </div>
    </div>
  </main>
